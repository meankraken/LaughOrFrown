...
namespace LaughOrFrown.Migrations
{
    ...
    [Migration("20161125044650_AddRatings3")]
    partial class AddRatings3
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("LaughOrFrown.Models.Joke", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("LaughUserId");

                    b.ToTable("Jokes");
                });

            modelBuilder.Entity("LaughOrFrown.Models.LaughUser", b =>
                {
            ...
            modelBuilder.Entity("LaughOrFrown.Models.Joke", b =>
                {
                    b.HasOne("LaughOrFrown.Models.LaughUser")
                        .WithMany("Jokes")
                        .HasForeignKey("LaughUserId");
                });
